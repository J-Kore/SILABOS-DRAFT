...
const APPS = [
  {
    ...
    tags: ["Conjugación", "Verbos", "Tiempos"],
    color: "#FF2DA6",
  ...
  },
  {
    ...
    tags: ["Pronunciación", "Conversación", "Tiempos"],
    color: "#A855F7",
